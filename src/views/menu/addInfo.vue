  ...
  <div>
    ...
    :before-close="cancel">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-else @click="update('ruleForm')" type="primary">编 辑</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
// console.log(indexRoutes,'indexRoutes1111');
